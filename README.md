...
Tut is designed to work seemlessly with sbt-site so that your checked
tutorials can be incorporated into your website.
...
When the buildSite task is run in sbt, the typechecked tutorials from
src/main/tut will be incorporated with the site generated by sbt-site
in target/site.
