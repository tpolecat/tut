...
The current version is **0.5.6** (changelog [here](CHANGELOG.md), upgrade instructions for 0.5.x series [here](#0.5.x)) which runs on **Scala 2.10**, **2.11**, **2.12**, and **2.13.0-M1**.

:sparkles: See the **0.6.x** branch for **sbt 1.0** support. :sparkles:
...
```
coursier launch -r "https://dl.bintray.com/tpolecat/maven/" org.tpolecat:tut-core_2.11:0.5.6 -- \
